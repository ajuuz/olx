...
const ProfileMenu = ({googleSignOut,userName}) => {
  return (
    <div>
      <div className="absolute px-10 py-3 shadow-2xl text-center left-[-30px] top-11 bg-white rounded-lg">
        <i class="fa-solid fa-caret-up fa-2x absolute top-[-20px] left-10 text-white"></i>
        <div className="py-2">
          {userName}
        </div>
